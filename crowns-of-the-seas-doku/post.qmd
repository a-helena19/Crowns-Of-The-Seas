...
![Das Hafenprofil eines einzelnen Hafens](assets/hafenprofil.png){ width="85%" }
...
![Das Büro zur Verwaltung der eigenen Flotte](assets/buero.png){ width="90%"}
...
![Das Erstellen einer neuen Session in der Lobby](assets/session-erstellen.png){ width="70%" }
...
![Die Lobby mit den aktuell aktiven Sessions](assets/aktive-sessions.png){ width="80%" }
...
![Manuelles Ablegen beim Lotsenstreik](assets/ablegen.png)
...
![Das Help Center mit allen Spielmechaniken in Kapiteln](assets/help-center.png){ width="90%" }
