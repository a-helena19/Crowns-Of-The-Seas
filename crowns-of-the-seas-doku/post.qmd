...
![Titelbild von Crowns of the Seas](assets/thumbnail.png){ width="90%" }
...
Crowns of the Seas ist ein webbasiertes Strategiespiel, in dem bis zu vier Reedereien gleichzeitig in einer geteilten Spielwelt gegeneinander antreten. Das Spiel ist in der Lehrveranstaltung Enterprise Applications entstanden.
Es greift die Idee des Klassikers Ports of Call als modernes Echtzeit-Multiplayer-Erlebnis für den Browser neu auf.
Im Mittelpunkt steht eine lebendige Wirtschaftssimulation aus Handel, Logistik, Risiko und direkter Konkurrenz.
Das Ergebnis ist ein lauffähiges Mehrspieler-Spiel mit vollständiger Kernschleife, das im Browser gespielt werden kann.
...
![Die Kartenansicht](assets/Mainscreen.png){ width="90%" }
...
![Die Frachtbörse mit den verfügbaren Aufträgen](assets/screenshot-frachtboerse.png)
...
Es wird keine Fracht transportiert, weswegen es auch keine Belohnung gibt.
Treibstoff und Zustand werden dennoch verbraucht, weswegen eine Leerfahrt zu einem kleinen Verlust führt.

![Eine Leerfahrt ohne Fracht zu einem anderen Hafen](assets/leerfahrt1.png)
...
![Der Schiffsmarkt mit den drei Schiffsklassen](assets/schiffsmarkt.png){ width="85%"}

Die eigene Flotte wird im Büro verwaltet. Dort sieht man alle eigenen Schiffe und ihre aktuellen Aufgaben im Überblick.


![Das Büro, von hier aus wird die eigene Flotte verwaltet](assets/buero.png){ width="90%"}

Zwischendurch müssen Schiffe betankt und repariert werden, was beides Zeit und Taler kostet und im Büro erledigt wird.
...
![Beim Lotsenstreik wird das Ablegen von Hand gesteuert](assets/ablegen.png)
...
Für einen leichten Einstieg sorgt ein geführtes Tutorial in der Lobby, das die wichtigsten Abläufe vor dem ersten Spiel erklärt.
Wenn Spielende später etwas nachschlagen möchten, können sie jederzeit ein integriertes Help Center öffnen, das alle Spielmechaniken in Kapiteln erklärt.
Tutorials können hier auch jederzeit erneut gestartet werden. Wenn man spezifischere Tutorials braucht, gibt es auch eigene Tutorials zu Reise, Leerfahrt, Reiseabschluss, Wartung und Luxusfrachten.
Dadurch müssen Spielende nicht immer das gesamte Tutorial abschließen. Ein Tutorial kann jederzeit beendet werden.
Dadurch findet sich jede:r auch ohne Vorwissen im Spiel zurecht und die Spielregeln bleiben transparent.

![Das Tutorial in der Lobby](assets/tutorial.mp4)

![Das Help Center erklärt alle Spielmechaniken in Kapiteln](assets/help-center.png){ width="90%" }
...
Dazu kommen viele kleine Elemente, die das Nutzer:innenerlebnis nochmals verbessern:

- Ein In-Game-Chat erlaubt die direkte Kommunikation zwischen Spielenden einer Lobby.
- Ein Leaderboard zeigt jederzeit Vermögen und Platzierung.
- Nach einem Verbindungsabbruch ist ein sauberes Wiederbeitreten möglich.
- Musik und Soundeffekte begleiten die Wechsel zwischen Lobby, Spiel und Minispielen.
- Das Spiel lässt sich im Vollbild spielen, was die Weltkarte und die Minispiele noch besser zur Geltung bringt.
...
![Der animierte Game-Over-Bildschirm mit Siegespodest und Leaderboard](assets/spielende.mp4)
...
Eine wichtige Regel betrifft laufende Reisen. Die Belohnung für eine Fracht wird erst gutgeschrieben, wenn das Schiff im Zielhafen angekommen ist.
Eine Reise, die gerade noch unterwegs ist, erhöht das Vermögen somit nicht.
...
![Zustandsdiagramm eines Schiffs](assets/ship-state-diagram.png){ width="70%" }
...
Die Routen zwischen den Häfen berechnet das Spiel automatisch als kürzesten Seeweg mit dem A-Star-Algorithmus.
Dieser schätzt über eine Heuristik, die Luftlinie zum Zielhafen, wie weit das Ziel noch entfernt ist und untersucht dadurch zuerst die vielversprechendsten Wege.
